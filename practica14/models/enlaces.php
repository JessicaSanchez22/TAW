...
class Paginas{
	...
	public static function enlacesPaginasModel($link){
		...
		if($link == "ingresar" || $link == "inventario" || $link == "editar" || $link == "salir" || $link == "dashboard" || $link == "usuarios" || $link == "categorias" || $link == "editarUsuario" || $link=="registroCategoria" || $link=="registro" || $link=="editarProducto" || $link=="editarCategoria" || $link=="borrarCategoria" || $link=="registroUsuario" || $link=="borrarProducto" || $link=="borrarUsuario" ||$link=="agregarStock" || $link=="tiendas" || $link=="registrarTienda" || $link=="editarTienda" || $link=="borrarTienda" || $link=="ventas"|| $link=="vender" || $link=="borrarVenta" || $link=="detalleVenta" || $link=="clientes" || $link=="registroClientes" || $link=="editarCliente"){
